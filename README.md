...
Previously, the project included DeepLab v3 comparisons, but the current code focuses on advanced U-Net–like approaches that utilize additional modules to handle the complexities of petrographic images under parallel and crossed polarized light.

1. Data Overview
Each rock thin section is imaged under:

Parallel Polarized Light (PPL) and
...
The main training script (which can be named something like pis_unet_train.py) demonstrates:
